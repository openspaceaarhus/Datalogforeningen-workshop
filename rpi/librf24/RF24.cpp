...
RF24::RF24(string _spidevice, uint32_t _spispeed, uint8_t _cepin, uint8_t _csnpin):
ce_pin(_cepin), spidevice( _spidevice), spispeed( _spispeed), csn_pin(_csnpin), wide_band(true), p_variant(false),
